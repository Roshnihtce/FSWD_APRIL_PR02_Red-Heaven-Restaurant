import json
from .Menu_management import MenuDashboard 
from .Employee_management import EmployeeManagement

path = r'E:/Red-Heaven-Restaurant/FSWD_APRIL_PR02_Red-Heaven-Restaurant/data/manager_credential.json'
...
class ManagerDashboard():
    ...
    def manager_menu(self):
        ...
        menu_managerment = MenuDashboard()
        ...
        while True:
            ...
            if choice == '1':
                ...
                menu_managerment.menu_management()
            elif choice == '5':
                self.sales_reports()
            elif choice == '6':
    ...
    def inventory_management(self):
        while True:
            ...
            if choice == '1':
                ...
                print("Low Stock Alerts... (Logic to be implemented)")
            elif choice == '6':
                break
            else:
                print("Invalid choice. Please try again.")
